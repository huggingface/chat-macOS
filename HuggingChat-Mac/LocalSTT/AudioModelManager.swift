...
//    var downloadingModels: [String: Bool] = [:]
...
//
//    // MARK: UI properties
//    private var transcriptionMode: TranscriptionMode = .streaming
...
//    }
//    
//    func downloadModel(_ model: String, redownload: Bool = false) {
...
//            } else {
//                // Download the model
//                _ = try await WhisperKit.download(variant: model, from: repoName, progressCallback: { progress in
